...
const boardElectionNavItems = [
  ...
  { label: "- Adriano Bertini", href: "/adriano-bertini", indent: true, active: true },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-gray-500 text-sm mb-8">4052 Basel</p>

              {/* Title */}
              <h2 className="text-sm uppercase tracking-wider text-gray-700 font-semibold mb-6">
                Head of Product and Strategy at Ledger Enterprise
              </h2>

              {/* Bio Paragraphs */}
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed mb-8">
                <p>
                  Adriano Bertini has a robust career in financial services, blockchain, and strategic
                  consulting, currently serving as the Head of Product and Strategy at Ledger
                  Enterprise. He has held various leadership roles in both established corporations and
                  innovative tech companies, driving projects that bridge the gap between traditional
                  finance and blockchain solutions. His experience spans project management, risk
                  management, and regulatory compliance, with a focus on cutting-edge technology and
                  cryptocurrency adoption. Adriano has been instrumental in promoting Bitcoin and
                  blockchain technology through various strategic initiatives. His deep knowledge of
                  both financial systems and blockchain solutions makes him a critical player in the
                  integration of cryptocurrencies into institutional frameworks.
                </p>
                <p>
                  Adriano is motivated to run for a board seat at the Bitcoin Association Switzerland
                  to drive the integration of Bitcoin into the financial mainstream. He believes that
                  his experience in both finance and blockchain technology will help shape the
                  Association&apos;s future, particularly in areas of regulatory compliance and institutional
                  adoption. Furthermore, he aims to increase Bitcoin awareness and forge strategic
              ...
              <div className="mb-8 space-y-2">
                <p>
                  <a
                    href="https://www.linkedin.com/in/adriano-bertini/"
                    target="_blank"
                ...
                <p className="text-sm text-gray-700">Telegram: @SeccoBit</p>
                <p>
                  <a
                    href="https://www.bitcoinassociation.ch/s/Adriano-Bertini.zip"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#c75b4a] hover:underline text-sm"
                  >
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex flex-col bg-[#1a1a1a]">
                      ...
                      <div className="bg-[#2a2a2a] text-white px-3 py-2 flex items-center gap-3">
                        ...
                        <span className="text-xs text-gray-400">02:22</span>
                        <button className="text-white hover:text-gray-300">
