...
const boardElectionNavItems = [
  ...
  { label: "- Lisa Tscherry", href: "/lisa-tscherry", indent: true, active: true },
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <h2 className="text-sm font-bold uppercase tracking-wider text-gray-900 mb-4">
                HR Business Partner at PwC Switzerland AG
              </h2>
              ...
              <div className="space-y-2 mb-6">
                <p>
                  <a
                    href="https://www.linkedin.com/in/lisa-tscherry/"
                    target="_blank"
                ...
                <p>
                  <a
                    href="https://www.bitcoinassociation.ch/s/Lisa-Tscherry.zip"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#8b7355] hover:underline text-sm"
                  >
                  ...
                  <div className="relative aspect-video bg-[#1a1a1a]">
                    ...
                    <div className="absolute inset-0 flex flex-col">
                      ...
                      <div className="bg-[#2a2a2a] px-3 py-2 flex items-center gap-3">
                        <span className="text-white text-xs">00:00 / 02:33</span>
