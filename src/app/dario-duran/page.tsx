...
const boardElectionNavItems = [
  ...
  { label: "- Dario Duran", href: "/dario-duran", indent: true, active: true },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-gray-500 text-sm mb-8">5210 Windisch</p>
              ...
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed mb-8">
                <p>
                  Dario Duran has a rich professional background spanning over several industries,
                  with roles in fintech startups, digital asset custody, and investment banking. He is
                  currently involved in a project aimed at creating a Bitcoin-denominated bank
                  account regulated in Switzerland and advises Swiss companies on establishing a
                  presence in the UAE. His previous roles include leadership positions in crypto
                  banking, transaction banking, and strategic business development for crypto wallet
                  startups. Dario&apos;s technical expertise dates back to introducing TCP/IP to UBS in
                  the 1990s, and he has been actively involved in Bitcoin technology since 2015,
                  running his own nodes and continuously learning by doing.
                </p>
                <p>
                  Dario is motivated to run for a board seat at the Bitcoin Association Switzerland,
                  particularly in roles like Secretary or Treasurer where he can apply his leadership
                  experience, financial oversight, and operational expertise. He is committed to
                  advancing the Association&apos;s mission and believes his versatile background in
                  business management and technology will be a valuable asset. Additionally, he sees
                  himself as a steady and reliable board member, ready to contribute to the success of
              ...
              <div className="mb-8 space-y-2">
                <p>
                  <a
                    href="https://www.linkedin.com/in/dario-duran/"
                    target="_blank"
                ...
                <p className="text-sm text-gray-700">Telegram: @mytwocentimes</p>
                <p>
                  <a
                    href="https://www.bitcoinassociation.ch/s/Dario-Duran.zip"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#c75b4a] hover:underline text-sm"
                  >
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex flex-col bg-[#1a1a1a]">
                      ...
                      <div className="bg-[#2a2a2a] text-white px-3 py-2 flex items-center gap-3">
                        ...
                        <span className="text-xs text-gray-400">02:13</span>
                        <button className="text-white hover:text-gray-300">
