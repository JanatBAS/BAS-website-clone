...
const boardElectionNavItems = [
  ...
  { label: "- Tobias Kress", href: "/tobias-kress", indent: true, active: true },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <div className="mb-8">
                <Image
                  src="https://images.squarespace-cdn.com/content/v1/5895d62d2994ca86b0cd9807/26da665a-13b1-41e0-ab04-59f2496de542/Tobias_pic.jpg"
                  alt="Tobias Kress"
                  width={280}
                  height={350}
                  className="object-cover"
              ...
              <p className="text-gray-500 text-sm mb-8">8048 Zurich</p>

              {/* Title */}
              <h2 className="text-sm uppercase tracking-wider text-gray-700 font-semibold mb-6">
                Head of Engineering at Rhino.fi & CEO at Tatoshi AG
              </h2>

              {/* Bio Paragraphs */}
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed mb-8">
                <p>
                  Tobias Kress is an experienced IT leader with over two decades of experience in
                  digital banking, blockchain, and cryptocurrency software development. He is the
                  CEO and Co-Founder of Tatoshi AG, a service provider specializing in Bitcoin
                  software development. Tobias also currently serves as the Head of Engineering at
                  Rhino.fi, where he is responsible for scaling the company and improving IT
                  processes. His career includes leadership roles as CTO at honesto AG and cpi
                  Crypto Payments International GmbH, as well as Director of Digital Solutions at
                  Credit Suisse. Tobias holds extensive knowledge in Bitcoin, decentralized finance,
                  and IT architecture, and has spoken at numerous international conferences on
                  cryptocurrency.
                </p>
                <p>
                  Tobias is running for a board seat at the Bitcoin Association Switzerland to
                  facilitate discussions on technical innovations in the Bitcoin space, particularly
                  around Layer 2 solutions and zk-rollups. He aims to revive the tradition of hosting
                  world-class speakers and events in Switzerland, ensuring that the community
                  remains up-to-date on Bitcoin&apos;s latest developments. Additionally, Tobias advocates
                  for using some of the Association&apos;s funds to support Bitcoin Core developers,
                  which he believes would significantly contribute to Bitcoin&apos;s growth.
                </p>
              </div>
              ...
              <div className="mb-8 space-y-2">
                <p>
                  <a
                    href="https://www.linkedin.com/in/tobias-kress-04a3bb68/"
                    target="_blank"
                ...
                <p className="text-sm text-gray-700">Telegram: @Tobias_ZH</p>
                <p>
                  <a
                    href="https://www.bitcoinassociation.ch/s/Tobias-Kress.zip"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#c75b4a] hover:underline text-sm"
                  >
