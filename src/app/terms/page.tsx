    ...
    <>
      ...
      <main className="pt-24 pb-16 bg-white min-h-screen">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Effective Date */}
          <p className="text-center text-[#c9a882] text-sm mb-12">
          ...
          <div className="prose prose-sm max-w-none text-gray-600">
            ...
            <section className="mb-8">
              ...
              <p className="text-sm leading-relaxed text-[#c9a882]">
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-4 text-sm text-[#c9a882]">
                <li>
