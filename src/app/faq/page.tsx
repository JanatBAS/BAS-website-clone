...
const faqItems: FAQItem[] = [
  ...
  {
    question: "2026 wallet address update",
    answer: (
      <>
        The wallet address in the 2024 election FAQ entries above is kept as historical context. For new membership payments and donations in 2026, please use the current BAS wallet address <span className="break-all">bc1qt0y4sz95wdfnd99tugs2z7njxm2uxpxkey8wxz0p5hhfm07j05sq3hd6ks</span>. Current details are listed on the <Link href="/finances" className="text-[#c75b4a] hover:underline">Finances</Link> page.
      </>
    ),
  },
  {
