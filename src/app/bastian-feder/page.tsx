...
const boardElectionNavItems = [
  ...
  { label: "- Bastian Feder", href: "/bastian-feder", indent: true, active: true },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-gray-500 text-sm mb-8">3007 Bern</p>

              {/* Title */}
              <h2 className="text-sm uppercase tracking-wider text-gray-700 font-semibold mb-6">
                CEO and Co-Founder of Lightning Payment Services AG (Lipa)
              </h2>

              {/* Bio Paragraphs */}
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed mb-8">
                <p>
                  Bastian Feder has over 21 years of experience in software development and
                  entrepreneurship. He is the CEO and co-founder of Lipa, a company that provides
                  accessible and reliable Bitcoin services. His previous roles include Lead Architect
                  and Tech Lead at Swisscom Banking, where he gained significant banking experience.
                  Bastian is also a keynote speaker and trainer, actively sharing his knowledge about
                  Bitcoin and software development. As a serial entrepreneur, he has initiated various
                  user groups and meetups, building communities around his areas of expertise.
                </p>
                <p>
                  Bastian is running for a board seat at the Bitcoin Association Switzerland to
                  strengthen Bitcoin&apos;s position in Switzerland and foster discussion around its
                  advantages and disadvantages. He aims to build a strong network of entrepreneurs,
                  visionaries, and influencers, positioning Switzerland as a pioneering financial
                  nation. Fully supporting the Orange Vision for the BAS, he is eager to represent it
              ...
              <div className="mb-8 space-y-2">
                <p>
                  <a
                    href="https://www.linkedin.com/in/bastianfeder/"
                    target="_blank"
                ...
                <p className="text-sm text-gray-700">Telegram: @lapistano</p>
                <p>
                  <a
                    href="https://www.bitcoinassociation.ch/s/Bastian-Feder.zip"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#c75b4a] hover:underline text-sm"
                  >
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex flex-col bg-[#1a1a1a]">
                      ...
                      <div className="bg-[#2a2a2a] text-white px-3 py-2 flex items-center gap-3">
                        ...
                        <span className="text-xs text-gray-400">02:28</span>
                        <button className="text-white hover:text-gray-300">
