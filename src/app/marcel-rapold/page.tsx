...
const boardElectionNavItems = [
  ...
  { label: "- Marcel Rapold", href: "/marcel-rapold", indent: true, active: true },
...
export default function MarcelRapoldPage() {
  return (
    <>
      ...
      <main className="py-12 bg-white min-h-screen mt-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-gray-500 text-sm mb-8">Erlenbach</p>

              {/* Title */}
              <h2 className="text-sm uppercase tracking-wider text-gray-700 font-semibold mb-6">
                IT Project Manager at Zurcher Verkehrsverbund (ZVV)
              </h2>

              {/* Bio Paragraphs */}
              <div className="space-y-6 text-sm text-gray-700 leading-relaxed mb-8">
                <p>
                  Marcel Rapold is a highly skilled IT Project Manager with over 15 years of
                  experience in the fields of digital transformation and process optimization. He has
                  led various high-impact projects at ZVV, focusing on improving customer
                  relationships and enhancing digital services. Marcel&apos;s expertise spans from technical
                  project management to implementing cutting-edge technologies such as the
                  Lightning Network and Nostr. He holds a Master of Advanced Studies (MAS) in
                  Digital Business and is currently pursuing an Executive MBA (to be completed in
                  2025). Marcel&apos;s background also includes entrepreneurship, having co-founded
                  ALPA.one, where he focuses on IT project development and innovation
                  management.
                </p>
                <p>
                  Marcel is running for a board seat at the Bitcoin Association Switzerland with the
                  goal of establishing it as a Bitcoin-only association. He aims to bring his strong
                  organizational skills to the role of Secretary, where he has already worked on
                  structuring BAS protocols, improving workflows for member onboarding, and
                  securing funds with a multisig wallet setup. Marcel&apos;s focus is on efficient
                  communication, process automation, and ensuring that BAS remains firmly
                  committed to Bitcoin&apos;s principles
                </p>
              </div>
              ...
              <div className="mb-8 space-y-2">
                ...
                <p className="text-sm text-gray-700">
                  ...
                  <a
                    ...
                    className="text-[#c75b4a] hover:underline"
                  >
                    npub17zja62hnnuz5yrqgdv5ummpcs4n3fflm7xkyp7lxtwzstedksd3sft2afg
                  </a>
                </p>
                <p className="text-sm">
                  <a
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute inset-0 flex flex-col bg-[#1a1a1a]">
                      ...
                      <div className="bg-[#2a2a2a] text-white px-3 py-2 flex items-center gap-3">
                        ...
                        <span className="text-xs text-gray-400">02:34</span>
                        <button className="text-white hover:text-gray-300">
