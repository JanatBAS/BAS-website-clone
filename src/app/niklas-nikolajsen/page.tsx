...
const boardElectionNavItems = [
  ...
  { label: "- Niklas Nikolajsen", href: "/niklas-nikolajsen", indent: true, active: true },
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <h2 className="text-sm font-bold text-gray-800 uppercase tracking-wider mb-4">
                Head of family office (various projects)
              </h2>
              ...
              <p className="text-sm text-gray-600 mb-4">
                Telegram:{" "}
                <a
                  href="https://t.me/niklasnikolajsen"
              ...
              <p className="mb-8">
                <a
                  href="https://www.bitcoinassociation.ch/s/Niklas-Nikolajsen-smcc.zip"
              ...
              <div className="mb-8">
                <div className="bg-[#1a1a1a] rounded overflow-hidden max-w-xl">
                  ...
                  <div className="bg-[#1a1a1a] text-white p-3 flex items-center gap-4">
                    ...
                    <span className="text-xs text-gray-400">00:00 / 03:07</span>
