    ...
    <div className="flex justify-center items-center gap-3">
      ...
      >
        <a
          ...
          aria-label="Meetup"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="12 12 40 40" className="w-6 h-6">
            <path
              fill="white"
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="14 18 36 28" className="w-6 h-6">
            <path
              fill="white"
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="16 15 32 34" className="w-5 h-5">
            <path
              fill="white"
